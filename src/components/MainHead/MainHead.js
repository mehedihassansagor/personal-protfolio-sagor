...
import myFile from '../images/resume 2.pdf'
        ...
        <div className="d-flex row  main-head">
            ...
            <div className="col-md-5 d-flex align-items-center col-sm-12">
                <div className="my-word">
                    ...
                    <h1 class="text-end"><span style={{ color: "green" }}>T</span>his is Mehedi Hassan <span style={{ color: "green" }}>S</span>agor</h1>
                    ...
                    <div className="mt-5">
                        <button type="button" class="btn btn-outline-success btn-lg">
                             <a target="_blank" style={{ textDecoration: "none", color: "green" }} href={myFile} download="resume2.pdf">Download Resume</a> </button>
